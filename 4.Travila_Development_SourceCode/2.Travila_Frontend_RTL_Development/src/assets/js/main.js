(function ($) {
            ...
            on: {
                afterInit: function () {
                    ...
                    if ($(".box-swiper-padding").length > 0) {
                        $(".box-swiper-padding").css("padding-right", leftTitle + "px");
                    }
                }
            }
        });
    ...
    $(window).resize(function () {
            ...
            if (_container2.length > 0) {
                ...
                $(".slider-thumnail").css("left","" + _offset_left2 + "px");
                setTimeout(function(){
                    var _prev_slide = $(".banner-main .slick-prev");
                    var _next_slide = $(".banner-main .slick-next");
                    _offset_left2 = _offset_left2 + 15;
                    _next_slide.css("right","" + _offset_left2 + "px");
                    _prev_slide.css("right","" + (_offset_left2 + 45) + "px");
                }, 200);
            }
    ...
    $(".block-testimonials").css("padding-right", _container_left + "px");
