...
document.getElementById('profileForm').addEventListener('submit', function (event) {
    ...
    // Display validation messages if form is invalid
    if (!isValid) {
      event.preventDefault(); // Prevent form submission
      form.reportValidity(); // Trigger browser's validation messages
    } else {
  ...
  function loadProfile() {
    ...
    if (savedProfile) {
      ...
      document.getElementById('contactNumber').value = savedProfile.contactNumber || '';
      document.getElementById('bio').value = savedProfile.bio || '';
      document.getElementById('languages').value = savedProfile.languages || '';
      document.getElementById('nationality').value = savedProfile.nationality || '';
    }
  }

  // Automatically load the profile when the page loads
  ...
  document.getElementById("saveChangesBtn").addEventListener("click", function () {
    ...
    if (!country || !state || !completeAddress) {
    ...
    localStorage.setItem("completeAddress", completeAddress);
 ...
 // Simulating a saved password in local storage
 localStorage.setItem("savedPassword", "oldPassword123"); // Set this to your predefined old password
 ...
 document.getElementById("savePasswordBtn").addEventListener("click", function () {
   ...
   // Get the saved old password from local storage
