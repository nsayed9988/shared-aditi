...
document.addEventListener("DOMContentLoaded", function () {
    ...
    blogPosts.forEach(post => {
        ...
        postElement.classList.add("card-news", "background-card", "hover-up");
        ...
        postElement.innerHTML = `
            ...
            <div class="card-info">
                <div class="card-meta">
                    <span class="post-date neutral-1000">${post.date}</span>
                </div>
                <div class="card-title">
                    <a class="text-xl-bold neutral-1000" href="#">${post.title}</a>
                </div>
                <div class="card-program">
                    <div class="endtime">
                        <div class="card-author">
                            <img src="assets/imgs/page/homepage1/avatar.png" alt="Author Avatar">
                            <p class="text-sm-bold neutral-1000">${post.author}</p>
                        </div>
                        <div class="card-button">
                            <a class="btn btn-gray" href="#">Keep Reading</a>
                        </div>
                    </div>
                </div>
            </div>
